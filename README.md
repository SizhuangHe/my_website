...
```shell
git clone https://github.com/SizhuangHe/my_website
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/my_website/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://SizhuangHe.github.io/my_website'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/SizhuangHe/my_website
  - link: https://github.com/SizhuangHe/my_website#readme
...
`https://SizhuangHe.github.io/my_website`